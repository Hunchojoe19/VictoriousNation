            ...
            <div className="content-container">
                ...
                <div className='connect'>
                    ...
                    <div className="social-media">
                        <div className="facebook"> <BsFacebook size={25} style={{ color: 'white', cursor: 'pointer'}}/></div>
                        <div className="twitter"> <BsTwitter size={25} style={{ color: 'white', cursor: 'pointer'}}/></div>
                        <div className="linkedin"> <BsLinkedin size={25} style={{ color: 'white', cursor: 'pointer'}}/></div>
                    </div>
                </div>
                <div style={{ width: '270px'}}>
